...
__vue_options__.__file = "E:\\Users\\Cole\\weex_project\\my_projectt\\src\\demo\\b2bapp\\executed.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-508f5330"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  created: function created() {
    ...
    var dataparam = [{ 'name': "method", 'value': "b2bapp.sales.select_step_task" }, { 'name': "app_key", 'value': "b2bapp" }, { 'name': "format", 'value': "json" }, { 'name': "datetime", 'value': _http2.default.formatTime(new Date()) }, { 'name': "v", 'value': '2.0' }, { 'name': "member_id", 'value': param.member_id }, { 'name': "week", 'value': week }];
    _http2.default.post(dataparam, function (res) {
      that.list = res.data;
      // modal.toast({message: param.member_id + "=========" + week })
      var dataparam = [{ 'name': "method", 'value': "b2bapp.sales.select_task_item" }, { 'name': "app_key", 'value': "b2bapp" }, { 'name': "format", 'value': "json" }, { 'name': "datetime", 'value': _http2.default.formatTime(new Date()) }, { 'name': "v", 'value': '2.0' }];
      _http2.default.post(dataparam, function (res) {
        ...
        if (that.list.length != 0) {
          ...
          for (var index1 in arr) {
            var arr_d = [];
            aaa: for (var index2 in that.task_items) {
              var i = 0;
  ...
  methods: {
    ...
    jump: function jump(task_link, detail_id, performance, event) {
      // var nav = weex.requireModule('navigator') ;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["t1"]
  }, [_vm._v("当前门店：" + _vm._s(_vm.member_name))])]), _c('wxc-tab-page', {
    ref: "wxc-tab-page",
    attrs: {
  ...
  }, _vm._l((_vm.list01), function(item_a, index_a, key_a) {
    return _c('div', {
      staticClass: ["item-container"]
    }, [_c('div', {
      staticClass: ["gird_column"]
    }, _vm._l((item_a), function(item_b, index_b, key_b) {
      return _c('div', [_c('div', {
        staticClass: ["gird_row"],
        on: {
          "click": function($event) {
            _vm.jump(item_b.task_link, item_b.detail_id, item_b.performance, $event)
          }
        }
      }, [_c('image', {
        staticClass: ["img1"],
        attrs: {
          "src": 'http://47.98.186.145/api/web/static/img/' + item_b.icon_url
        }
      }), _c('text', {
        staticClass: ["text2"]
      }, [_vm._v(_vm._s(item_b.task_name))]), _c('div', {
        staticClass: ["item_right"]
      }, [_c('text', {
        staticClass: ["text3"]
      }, [_vm._v(_vm._s(item_b.performance))])]), _c('image', {
        staticClass: ["img2"],
        attrs: {
