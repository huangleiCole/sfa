...
/* styles */
__vue_styles__.push(__webpack_require__(569)
)

/* script */
__vue_exports__ = __webpack_require__(570)
...
__vue_options__.__file = "E:\\Users\\Cole\\weex_project\\my_projectt\\src\\demo\\b2bapp\\sign_in.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-09688856"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  ...
  methods: {
    showIn: function showIn() {
      ...
      _http2.default.postPhoto(6, param, function (res1) {
        //modal.toast({ message: res1 });
        var dataparam = [{ 'name': "method", 'value': "b2bapp.sales.sign_in" }, { 'name': "app_key", 'value': "b2bapp" }, { 'name': "format", 'value': "json" }, { 'name': "datetime", 'value': _http2.default.formatTime(new Date()) }, { 'name': "v", 'value': '2.0' }, { 'name': "week", 'value': week }, { 'name': "member_id", 'value': that.member_id }, { 'name': "task_id", 'value': 1 }, { 'name': "file_content", 'value': res1 }, { 'name': "file_type", 'value': 1 }, { 'name': "creator", 'value': 'wyc' }];
        _http2.default.post(dataparam, function (res2) {
          if (res2.data == 3) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    class: [_vm.change_div ? 'd2' : 'd3'],
    on: {
      "click": _vm.showIn
    }
  }, [_c('text', {
    staticClass: ["text"]
  }, [_vm._v(_vm._s(_vm.change_name))])])]), _c('div', {
    staticClass: ["p1"]
  }, [_c('div', {
    staticClass: ["p2"]
  }, [_c('image', {
