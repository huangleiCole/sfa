...
__vue_options__.__file = "E:\\Users\\Cole\\weex_project\\my_projectt\\src\\demo\\b2bapp\\execute.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-340e29e4"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
  components: { WxcPanItem: _weexUi.WxcPanItem },
  data: function data() {
    return {
      list: [],
      list01: [],
  ...
  created: function created() {
    ...
    var dataparam = [{ 'name': "method", 'value': "b2bapp.sales.select_day_task" }, { 'name': "app_key", 'value': "b2bapp" }, { 'name': "format", 'value': "json" }, { 'name': "datetime", 'value': _http2.default.formatTime(new Date()) }, { 'name': "v", 'value': '2.0' }, { 'name': "member_id", 'value': that.member_id }];
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, _vm._l((_vm.list01), function(item, index, key) {
    return _c('div', [_c('div', {
      staticClass: ["gird_row"],
      on: {
        "click": function($event) {
          _vm.jump(item.task_link, item.detail_id, item.performance, $event)
        }
      }
    }, [_c('image', {
      staticClass: ["img1"],
      attrs: {
        "src": 'http://47.98.186.145/api/web/static/img/' + item.icon_url
      }
    }), _c('text', {
      staticClass: ["text2"]
    }, [_vm._v(_vm._s(item.task_name))]), _c('div', {
      staticClass: ["item_right"]
    }, [_c('text', {
      staticClass: ["text3"]
    }, [_vm._v(_vm._s(item.performance))])]), _c('image', {
      staticClass: ["img2"],
      attrs: {
