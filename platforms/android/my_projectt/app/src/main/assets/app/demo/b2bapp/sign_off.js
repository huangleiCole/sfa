...
__vue_options__.__file = "E:\\Users\\Cole\\weex_project\\my_projectt\\src\\demo\\b2bapp\\sign_off.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-565b908e"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
	...
	created: function created() {
		...
		var dataparam = [{ 'name': "method", 'value': "b2bapp.sales.nowday_signin_time" }, { 'name': "app_key", 'value': "b2bapp" }, { 'name': "format", 'value': "json" }, { 'name': "datetime", 'value': _http2.default.formatTime(new Date()) }, { 'name': "v", 'value': '2.0' }, { 'name': "member_id", 'value': that.member_id }];
	...
	methods: {
		showOff: function showOff(event) {
			...
			var dataparam = [{ 'name': "method", 'value': "b2bapp.sales.sign_off" }, { 'name': "app_key", 'value': "b2bapp" }, { 'name': "format", 'value': "json" }, { 'name': "datetime", 'value': _http2.default.formatTime(new Date()) }, { 'name': "v", 'value': '2.0' }, { 'name': "member_id", 'value': that.member_id }, { 'name': "creator", 'value': "wyc" }];
			_http2.default.post(dataparam, function (res) {
				if (res.data == 3) {
					modal.toast({
						message: '签出成功！时间：' + _time2.default.CurentTime(),
						duration: 3
					});
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["t1", "left_gap"]
  }, [_vm._v("当前门店")]), _c('text', {
    staticClass: ["t1"]
  }, [_vm._v(_vm._s(_vm.member_name))])]), _c('div', {
    staticClass: ["item_right"]
  }, [_c('text', {
    staticClass: ["t3", "right_gap"]
  }, [_vm._v("签到时间")]), _c('text', {
    staticClass: ["t3"]
  }, [_vm._v(_vm._s(_vm.sign_in_time))])])]), _c('div', {
