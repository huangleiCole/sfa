...
__vue_options__.__file = "E:\\Users\\Cole\\weex_project\\my_projectt\\src\\demo\\b2bapp\\questionnaireed.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-4e8d5a71"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    ...
    created: function created() {
        ...
        var dataparam = [{ 'name': "method", 'value': "b2bapp.sales.select_question_answers" }, { 'name': "app_key", 'value': "b2bapp" }, { 'name': "format", 'value': "json" }, { 'name': "datetime", 'value': _http2.default.formatTime(new Date()) }, { 'name': "v", 'value': '2.0' }, { 'name': "detail_id", 'value': param.detail_id }];
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
    ...
    staticClass: ["t1"]
  }, [_vm._v("当前门店：" + _vm._s(_vm.member_name))])]), _c('scroller', _vm._l((_vm.list), function(item, index, key) {
    return _c('div', [(item.type_id == '1') ? _c('div', [_c('text', {
      staticClass: ["text2"]
    }, [_vm._v("  " + _vm._s(index + 1) + ". " + _vm._s(item.ques_desc))]), _c('text', {
      staticClass: ["text3"]
    }, [_vm._v("      " + _vm._s(item.answer))])]) : (item.type_id == '2') ? _c('div', [_c('text', {
      staticClass: ["text2"]
    }, [_vm._v("  " + _vm._s(index + 1) + ". " + _vm._s(item.ques_desc))]), _c('text', {
      staticClass: ["text3"]
    }, [_vm._v("      " + _vm._s(item.answer))])]) : (item.type_id == '3') ? _c('div', [_c('text', {
      staticClass: ["text2"]
    }, [_vm._v("  " + _vm._s(index + 1) + ". " + _vm._s(item.ques_desc))]), _c('text', {
      staticClass: ["text3"]
    }, [_vm._v("      " + _vm._s(item.answer))])]) : (item.type_id == '4') ? _c('div', [_c('text', {
      staticClass: ["text2"]
    }, [_vm._v("  " + _vm._s(index + 1) + ". " + _vm._s(item.ques_desc))]), _vm._l((item.answer), function(item_a, index, key) {
      return _c('div', [_c('text', {
        staticClass: ["text3"]
      }, [_vm._v("      " + _vm._s(item_a))])])
    })], 2) : (item.type_id == '5') ? _c('div', [_c('text', {
      staticClass: ["text2"]
    }, [_vm._v("  " + _vm._s(index + 1) + ". " + _vm._s(item.ques_desc))]), _c('div', {
      staticClass: ["p1"]
    }, [_c('div', {
      staticClass: ["p2"]
    }, [_c('image', {
