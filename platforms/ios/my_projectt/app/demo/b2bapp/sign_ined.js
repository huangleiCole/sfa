...
__vue_options__.__file = "E:\\Users\\Cole\\weex_project\\my_projectt\\src\\demo\\b2bapp\\sign_ined.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-a3b69416"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
var _time = __webpack_require__(272);
...
exports.default = {
  ...
  created: function created() {
    ...
    var dataparam = [{ 'name': "method", 'value': "b2bapp.sales.sign_ined" }, { 'name': "app_key", 'value': "b2bapp" }, { 'name': "format", 'value': "json" }, { 'name': "datetime", 'value': _http2.default.formatTime(new Date()) }, { 'name': "v", 'value': '2.0' }, { 'name': "detail_id", 'value': param.detail_id }];
    _http2.default.post(dataparam, function (res) {
      var str = res.data[0].file_content;
      modal.toast({ message: str });
      var splstr = str.split("|");
      that.src01 = "http://47.98.186.145/api/web/static/photo/" + splstr[0] + ".jpg";
      that.src02 = "http://47.98.186.145/api/web/static/photo/" + splstr[1] + ".jpg";
      that.src03 = "http://47.98.186.145/api/web/static/photo/" + splstr[2] + ".jpg";
      that.src04 = "http://47.98.186.145/api/web/static/photo/" + splstr[3] + ".jpg";
      that.src05 = "http://47.98.186.145/api/web/static/photo/" + splstr[4] + ".jpg";
      that.src06 = "http://47.98.186.145/api/web/static/photo/" + splstr[5] + ".jpg";
    });
  ...
  methods: {
    ...
    //},
    takingPictures01: function takingPictures01() {
      var self = this;
    ...
    takingPictures02: function takingPictures02() {
      var self = this;
      var photo = weex.requireModule('photo');
      photo.openCamera(1500, 2000, '#000000', function (e) {
        self.src02 = e.path;
    ...
    takingPictures03: function takingPictures03() {
      var self = this;
      var photo = weex.requireModule('photo');
      photo.openCamera(1500, 2000, '#000000', function (e) {
        self.src03 = e.path;
    ...
    takingPictures04: function takingPictures04() {
      var self = this;
      var photo = weex.requireModule('photo');
      photo.openCamera(1500, 2000, '#000000', function (e) {
        self.src04 = e.path;
    ...
    takingPictures05: function takingPictures05() {
      var self = this;
      var photo = weex.requireModule('photo');
      photo.openCamera(1500, 2000, '#000000', function (e) {
        self.src05 = e.path;
    ...
    takingPictures06: function takingPictures06() {
      var self = this;
      var photo = weex.requireModule('photo');
      photo.openCamera(1500, 2000, '#000000', function (e) {
        self.src06 = e.path;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["t1"]
  }, [_vm._v("当前门店：" + _vm._s(_vm.member_name))])]), _c('div', {
    staticClass: ["gird_column"]
  }, [_c('div', {
    staticClass: ["gird_row"]
  }, [_c('image', {
    staticClass: ["img3"],
    attrs: {
      "src": "http://47.98.186.145/api/web/static/img/bld.jpg"
    }
  }), _c('div', [_c('text', {
    staticClass: ["text2"]
  }, [_vm._v(_vm._s(_vm.member_name))]), _c('text', {
    staticClass: ["text5"]
  }, [_vm._v(_vm._s(_vm.area))]), _c('text', {
    staticClass: ["text5"]
  }, [_vm._v(_vm._s(_vm.addr))])]), _c('text', {
    staticClass: ["text3"]
  })]), _c('div', {
    staticClass: ["h"]
  }), _c('div', {
    staticClass: ["gird_row1"]
  }, [_c('image', {
    staticClass: ["img4"],
    attrs: {
      "src": "http://47.98.186.145/api/web/static/img/location.png"
    }
  }), _c('text', {
    staticClass: ["text5"]
  }, [_vm._v(_vm._s(_vm.addr))]), _c('text', {
    ...
    staticClass: ["img5"],
    attrs: {
      "src": "http://47.98.186.145/api/web/static/img/t.png"
    }
  }), _c('div', {
    staticClass: ["d"]
  }), _c('image', {
    staticClass: ["img5"],
    attrs: {
      "src": "http://47.98.186.145/api/web/static/img/phone.png"
    }
  })]), _c('div', {
    staticClass: ["h"]
  })]), _vm._m(0), _c('div', {
